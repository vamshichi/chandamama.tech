...
export default function PopularGadgetsSection({ currentSlug }: PopularGadgetsSectionProps) {
  const filteredGadgets = gadgetsData
    ...
    .slice(0, 6); // Limit to 6 gadgets for scrolling
          ...
          <div className="overflow-x-auto whitespace-nowrap scrollbar-hide">
            <div className="inline-flex space-x-6">
              {filteredGadgets.map((gadget) => (
                <div 
                  key={gadget.id} 
                  className="bg-white p-4 border rounded-lg shadow-md flex flex-col w-72 transition duration-300 ease-in-out hover:shadow-lg"
                >
